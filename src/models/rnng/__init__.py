...
def get_rnn_slm_ptb():
    return make_ptb_512_model("rnn-slm-ptb", "lstm-mean")

def get_rnn_tdg_ptb():
    return make_ptb_512_model("rnn-tdg-ptb", "rnng-mean")

def get_rnn_slm_ptboanc():
    return make_ptboanc_512_model("rnn-slm-ptboanc", "lstm-mean")

def get_rnn_tdg_ptboanc():
    return make_ptboanc_512_model("rnn-tdg-ptboanc", "rnng-mean")

def get_rnn_slm_ptboanc_1024():
    return make_ptboanc_1024_model("rnn-slm-ptboanc-1024", "lstm-mean")

def get_rnn_tdg_ptboanc_1024():
    return make_ptboanc_1024_model("rnn-tdg-ptboanc-1024", "rnng-mean")
