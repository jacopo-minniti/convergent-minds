...
from models.earley_parser.parser import EarleyParserSubject
from models.earley_parser import get_earley_parser_minivocab
...
def test_create_grammar(model_identifier, treebank_path, hparams, expected_grammar):
    ...
    """
    model: EarleyParserSubject = get_earley_parser_minivocab()
...
def test_create_grammar_integration_reading_times(
    ...
    """
    model = get_earley_parser_minivocab()
    model.create_grammar(
        treebank_path=treebank_path,
        fileids="sample_treebank",
        k=1,
