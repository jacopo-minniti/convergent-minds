import numpy as np
import pytest
from brainscore import ArtificialSubject, score, load_benchmark

from models.random_embedding import WordToEmbedding, get_randomembedding_1600, get_randomembedding_100
...
def test_neural():
    model = get_randomembedding_1600()
...
def test_score():
    model = get_randomembedding_100()
    benchmark = load_benchmark('Pereira2018.243sentences-linear')
    result = score(model, benchmark)
