...
from brainscore.model_helpers.embedding import EmbeddingSubject
...
def get_randomembedding_1600():
    return EmbeddingSubject(identifier='randomembedding-1600', lookup=WordToEmbedding(1600))

def get_randomembedding_100():
    return EmbeddingSubject(identifier='randomembedding-100', lookup=WordToEmbedding(100))
