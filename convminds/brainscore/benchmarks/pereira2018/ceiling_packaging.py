...
from convminds.brainscore import load_benchmark
from convminds.brainscore.benchmark_helpers import ci_error, manual_merge
from convminds.brainscore.utils import fullname
from convminds.brainscore.utils.s3 import upload_data_assembly
from convminds.brainscore.utils.transformations import apply_aggregate
...
def upload_ceiling(experiment, metric):
    benchmark = load_benchmark(f'Pereira2018.{experiment}')
    ceiler = ExtrapolationCeiling()
    ceiling = ceiler(benchmark.data, metric=metric)
