...
from convminds.brainscore import load_benchmark, score
from convminds.brainscore.submission import config


class LanguagePlugins(DomainPlugins):
    def load_model(self, model_identifier: str):
        raise NotImplementedError("Model lookup by identifier is not enabled. Instantiate models directly.")
