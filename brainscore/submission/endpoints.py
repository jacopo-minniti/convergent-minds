...
from brainscore import load_benchmark, score
from brainscore.submission import config


class LanguagePlugins(DomainPlugins):
    def load_model(self, model_identifier: str):
        # return load_model(model_identifier)
        raise NotImplementedError("Model registry has been removed. Please instantiate models directly.")
