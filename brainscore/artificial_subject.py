...
class ArtificialSubject:
    ...
    def start_behavioral_task(self, task: Task):
        ...
        :meth:`~brainscore.artificial_subject.ArtificialSubject.digest_text`. Calling
        :meth:`~brainscore.artificial_subject.ArtificialSubject.digest_text` will then output a
        :class:`~brainio.assemblies.BehavioralAssembly` in the `'behavior'` part of the output dict.

        :param task: Which :class:`~brainscore.artificial_subject.ArtificialSubject.Task` to use.
        """
        raise NotImplementedError()
    ...
    def digest_text(self, text: Union[str, List[str]]) -> Dict[str, DataAssembly]:
        ...
        :return: a dictionary mapping from `'behavior'` and `'neural'` to a :class:`~brainio.assemblies.DataAssembly`,
            ...
            :meth:`~brainscore.artificial_subject.ArtificialSubject.start_behavioral_task` and/or
            :meth:`~brainscore.artificial_subject.ArtificialSubject.start_neural_recording` respectively.
